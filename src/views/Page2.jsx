      ...
      return (
            <div className="page2Container">
                  <div className="textoBotonesPage2">
                        ...
                        <button className="btnProyectos">VER MÁS</button>
                  </div>
                  <div className="imagenPage2">
                                    ...
                                    <img
                                          src={Ecommerce}
                                          alt=""
                                          className="ecommerceImg"
                                    />
                                    <img
                                          src={FoodApp}
                                          alt=""
                                          className="foodAppImg"
                                    />
                                    <img
                                          src={WeatherApp}
                                          alt=""
                                    ...
                                    />
                                     <img
                                          src={Ecommerce}
                                          alt=""
                                          className="ecommerceImg1"
                                    />
                                    <img
                                          src={FoodApp}
                                          alt=""
                                          className="foodAppImg1"
                                    />
                                    <img
                                          src={WeatherApp}
                                          alt=""
                                    ...
                                    />
                                      <img
                                          src={Ecommerce}
                                          alt=""
                                          className="ecommerceImg2"
                                    />
                                    <img
                                          src={FoodApp}
                                          alt=""
                                          className="foodAppImg2"
                                    />
                                    <img
                                          src={WeatherApp}
                                          alt=""
                                    ...
                                    />
                                      <img
                                          src={Ecommerce}
                                          alt=""
                                          className="ecommerceImg3"
                                    />
                                    <img
                                          src={FoodApp}
                                          alt=""
                                          className="foodAppImg3"
                                    />
                                    <img
                                          src={WeatherApp}
                                          alt=""
